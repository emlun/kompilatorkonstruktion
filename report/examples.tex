...
Notice how templates can reference each other, and template arguments can in
turn have their own template arguments (\textbf{Maybe\tmpl{LinkedList\tmpl{T}}}.
...
Container\tmpl{T} that in the second part has been expanded into two concrete
